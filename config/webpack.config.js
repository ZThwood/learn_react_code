    ...
    return {
        ...
        resolve: {
            ...
            alias: {
                ...
                'react-server': path.resolve(__dirname, '../src/react/packages/react-server'),
                'react-server-dom-webpack': path.resolve(__dirname, '../src/react/packages/react-server-dom-webpack'),
            },
            plugins: [
